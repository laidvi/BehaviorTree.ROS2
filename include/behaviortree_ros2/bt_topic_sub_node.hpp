...
namespace BT
{
        ...
        node_(params.nh)
  {
    ...
    // Added by David to redefine params.server_timeout as the message publishing periodfor subscriber
    sleep_ms_ = params.server_timeout;
  }
  ...
  template <class T>
  inline void RosTopicSubNode<T>::topicCallback(const std::shared_ptr<T> msg)
  {
    last_msg_ = msg;
  }
